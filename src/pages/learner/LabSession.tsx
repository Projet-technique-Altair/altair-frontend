 ...
 *
 * IMPORTANT:
 * - Lab metadata comes from the real backend (GET /labs/:id)
 * - Interactive steps are runtime data (mocked for now)
 * - No backend fields are invented
 */
...
// ===== TEMP MOCK DATA ===
// =======================
// This will be replaced later by:
// - a Lab Runtime microservice
// - or a Kubernetes-backed scenario engine

const MOCK_SESSION_DATA: LabSessionData = {
  labId: "placeholder",
  steps: [
    {
      title: "Welcome to the Lab",
      instruction: "Type `echo hello` in the terminal.",
      expected: "echo hello",
...
export default function LabSession() {
  ...
  const handleHint = () => {
    setFeedback(
      current.hint ? `💡 Hint: ${current.hint}` : "No hint available."
    );
  };
